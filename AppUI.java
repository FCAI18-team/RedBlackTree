...
public class AppUI <T extends Comparable<T>> extends JPanel {
    ...
    private void setTopPanel() {
        ...
        b_insert.setBackground(new Color(123,213,123));
        b_delete.setFocusPainted(false);
        b_delete.setBackground(new Color(223,113,123));
        ...
        textBox.setFont(Font.getFont(Font.SERIF));
        ...
        panel.setBorder(BorderFactory.createEmptyBorder(8,300,8,300));
